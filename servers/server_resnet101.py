...
try:
    ...
    setproctitle("gate-classifier-std")
except ImportError:
...
# Preprocessing transforms (must match training - 224x224 for MobileNetV3)
transform = transforms.Compose([
    transforms.Lambda(lambda img: img.crop(crop_box)),
...
app = FastAPI(title="Gate Classification API", description="ResNet101-based gate status classifier")
