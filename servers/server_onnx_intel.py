...
try:
    ...
    setproctitle("gate-classifier-onnx")
except ImportError:
    pass  # setproctitle not available, continue without it

# Configuration
MODEL_PATH = os.getenv("ONNX_MODEL", "gate_mobilenetv3.onnx")
INPUT_SIZE = (224, 224)
...
app = FastAPI(title="Gate Classification API - ONNXRuntime (Intel GPU preferred)")

def preprocess(image: Image.Image) -> np.ndarray:
    """Preprocess image exactly matching training pipeline"""
    # Convert to RGB and apply crop and rotation like training
